		...
		<form class="" action="#" method="post" enctype="multipart/form-data">
			...
			<div class="form-row">
				<div class="col">
					...
					<input type="text" name="kec" required="true" class="form-control" value="<?php echo $kec ?>">
				</div>
				<div class="col">
					<label for="">kabupaten</label>
					<input type="text" name="kab" required="true" class="form-control" value="<?php echo $kab ?>">
				</div>
			</div>
			<div class="form-row">
				<div class="col">
